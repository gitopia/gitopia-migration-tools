module github.com/gitopia/gitopia-migration-tools/update-script
...
require (
	...
	github.com/gitopia/gitopia-migration-tools/shared v0.0.4
...
require (
	...
	github.com/ipfs-cluster/ipfs-cluster v1.1.2 // indirect
